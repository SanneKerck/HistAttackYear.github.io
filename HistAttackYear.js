...
var margin = {top: 20, right: 30, bottom: 160, left: 65},
...
// Get the Data
d3.csv("https://gist.githubusercontent.com/SanneKerck/2ce8674dda67ccc5475f63a8c599839a/raw/ef6038cb05a00d4092ecd315730f29ccf88a7baf/HistAttackYear.csv", function(data) {  
//d3.csv("HistAttackYear.csv", function(data) {    
    ...
    svg.append("text")
        ...
        .text("Histogram of the number of attacks by year given weapon type");
